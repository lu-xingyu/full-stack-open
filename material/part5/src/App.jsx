...
const App = () => {
  ...
  //target is form, form has elements property, can user event.target.elements.username 
  //to access the DOM inside of the form, username needs to be name property of the DOM
  ...
  return (
    <div>
      ...
      {!user && loginForm()} {/*if the first statement is true, the second statement is executed; if the first statement is falsy, the second statement is not executed at all*/}
      {user && (
        <div>
