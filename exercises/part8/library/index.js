...
const resolvers = {
  Query: {
    ...
    allBooks: (root, args) => {
        const bookByAuthor = args.author ? books.filter(book => book.author === args.author) :books
        const bookByGenre = args.genre ? bookByAuthor.filter(book => book.genres.includes(args.genre)) :bookByAuthor
        return bookByGenre
    },
    allAuthors: () => authors
  },
